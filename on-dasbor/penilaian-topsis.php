...
?>
			<div class="col-md-12">
				...
				<p>
					...
					<b>Tabel Penilaian Guru</b><br />
					<form action="proses_topsis.php" enctype="multipart/form-data" method="GET">
						<table class="table table-bordered table-hover table-striped text-center">
							<tr>
							...
							<?php
								$result_guru = mysqli_query($connect,"SELECT nip,nama FROM guru ORDER BY id");
								if ($result_guru) {
